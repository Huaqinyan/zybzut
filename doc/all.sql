...
insert into `test` (id, name, password) values (1,'测试','密码');
...
insert into `ebook` (id,name,description) values (1, 'Spring Boot入门教程' ,'零基础入门 Java 开发，企业级应用开发最佳首选框架');
...
insert into `category` (id, parent, name, sort) values (302,300,'进阶方向开发',302);
